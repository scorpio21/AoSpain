...
Call engine.Device_Box_Textured_Render(textura, XPosCartel, YPosCartel, GrhData(textura).pixelWidth, GrhData(textura).pixelHeight, rgb_list(), GrhData(textura).sX, GrhData(textura).sY, False)
